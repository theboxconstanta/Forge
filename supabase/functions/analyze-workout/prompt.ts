...
- Chained AMRAP: mai multe etape AMRAP/interval legate "straight into" in ACELASI bloc de scor (o SINGURA sectiune, nu mai multe sectiuni separate), scor = total reps pe toate etapele
