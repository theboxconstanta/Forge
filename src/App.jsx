...
function NavBar({ screen, setScreen, isAdmin, feedUnread }) {
  ...
  return (
    ...
    <nav
      ref={navRef}
      className="app-frame fixed bottom-0 left-1/2 z-[100] flex w-full max-w-[430px] -translate-x-1/2 items-center justify-center gap-2 border-t border-gray-200 bg-white pt-2"
